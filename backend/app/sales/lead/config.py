...
def get_lead_statuses(organization_id: Optional[int] = None) -> List[str]:
    ...
    return loop.run_until_complete(get_sales_config_from_superadmin("lead_statuses", organization_id))
...
def get_lead_sources(organization_id: Optional[int] = None) -> List[str]:
    ...
    # Run the async function
    return loop.run_until_complete(get_sales_config_from_superadmin("lead_sources", organization_id))