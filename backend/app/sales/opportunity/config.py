...
def get_opportunity_stages(organization_id: Optional[int] = None) -> List[str]:
    ...
    return loop.run_until_complete(get_sales_config_from_superadmin("opportunity_stages", organization_id))
...
def get_closed_won_stage(organization_id: Optional[int] = None) -> str:
    ...
    # Run the async function
    return loop.run_until_complete(get_sales_config_from_superadmin("closed_won_stage", organization_id))