...
def get_quotation_statuses(organization_id: Optional[int] = None) -> List[str]:
    ...
    return loop.run_until_complete(get_sales_config_from_superadmin("quotation_statuses", organization_id))
...
def get_default_tax_rate(organization_id: Optional[int] = None) -> float:
    ...
    # Run the async function
    return loop.run_until_complete(get_sales_config_from_superadmin("default_tax_rate", organization_id))