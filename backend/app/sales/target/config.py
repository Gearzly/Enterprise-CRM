...
def get_target_periods(organization_id: Optional[int] = None) -> List[str]:
    ...
    return loop.run_until_complete(get_sales_config_from_superadmin("target_periods", organization_id))
...
def get_target_types(organization_id: Optional[int] = None) -> List[str]:
    ...
    # Run the async function
    return loop.run_until_complete(get_sales_config_from_superadmin("target_types", organization_id))